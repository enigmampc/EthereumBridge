...
class TerraIngressSigner(IngressSigner):
    def __init__(
        self,
        config: Config,
        s20_multisig: SecretAccount,
        terra_multisig: str,
        cli: GaiaCli,
    ):
    ...
    def verify_transaction(
        self, tx_hash: str, recipient: str, amount: int, token: str
    ) -> bool:
        ...
        # TODO extract values from contract
        ...
        if self._terra_multisig != details["to_address"]:
